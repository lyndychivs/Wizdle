...
[Files]
Source: "C:\git\Wizdle\Wizdle.Windows\bin\Release\net9.0-windows\publish\win-x86\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\git\Wizdle\Wizdle.Windows\bin\Release\net9.0-windows\publish\win-x86\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
