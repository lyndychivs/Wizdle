...
| Prerequisite | Note |
| --- | --- |
| `ILogger` implementation | This library requires an implementation of `Microsoft.Extensions.Logging` to construct. (See the `Serilog` example in [Wizdle.Integration.Tests/Logger.cs](https://github.com/lyndychivs/Wizdle/blob/main/tests/integration/Wizdle.Integration.Tests/Logger.cs).) |
