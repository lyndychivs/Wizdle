...
/// <summary>
/// The command line arguments for the <c>solve</c> verb.
/// </summary>
...
{
    /// <summary>
    /// Gets or sets the correct letters known to exist in the word.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the misplaced letters known to exist in the word.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the letters known to not exist in the word.
    /// </summary>
